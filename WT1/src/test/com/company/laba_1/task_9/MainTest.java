package test.com.company.laba_1.task_9;

import org.junit.jupiter.api.Test;
import main.com.company.laba_1.task_9.*;
import java.awt.*;
...
class MainTest {
    ...
    void givenBasketWithTwoBlueBalls_whenCountBlueBallsInBasket_thenReturnTwo() {
        ...
        int expected = 2;
        int actual = Main.countBlueBalls(basket);
    ...
    void givenBasketWithBalls_whenCountWeightOfBallsInBasket_thenReturnWeightOfBalls() {
        ...
        int expected = 135;
        int actual = Main.countWeightOfBalls(basket);
        assertEquals(expected, actual);
    }
